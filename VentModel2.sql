-- The aim of this query is to pivot entries related to the Vent Model Study and
-- chemistry values which were found in LABEVENTS

DROP MATERIALIZED VIEW IF EXISTS Vent_Model CASCADE;
CREATE MATERIALIZED VIEW Vent_Model as
